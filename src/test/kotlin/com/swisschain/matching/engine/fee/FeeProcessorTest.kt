...
class FeeProcessorTest {
    ...
    fun testNoPercentageFee() {
        ...
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 1, "USD", BigDecimal.valueOf(-10.0)))
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 2, "USD", BigDecimal.valueOf(10.0)))
    ...
    fun testNoAbsoluteFee() {
        ...
        val operations = LinkedList<WalletOperation>()
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 1, "USD", BigDecimal.valueOf(-0.5)))
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 2, "USD", BigDecimal.valueOf(0.5)))
        val originalOperations = LinkedList(operations)
        val receiptOperation = operations[1]
    ...
    fun testClientPercentageFee() {
        val operations = LinkedList<WalletOperation>()
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 1, "USD", BigDecimal.valueOf(-10.1)))
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 2, "USD", BigDecimal.valueOf(10.1)))
        val receiptOperation = operations[1]
        val originalOperations = LinkedList(operations)
    ...
    fun testClientAbsoluteFee() {
        val operations = LinkedList<WalletOperation>()
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 1, "USD", BigDecimal.valueOf(-11.1)))
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 2, "USD", BigDecimal.valueOf(11.1)))
        val receiptOperation = operations[1]
        val originalOperations = LinkedList(operations)
    ...
    fun testClientPercentageFeeRound() {
        val operations = LinkedList<WalletOperation>()
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 1, "USD", BigDecimal.valueOf(-29.99)))
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 2, "USD", BigDecimal.valueOf(29.99)))
        val receiptOperation = operations[1]
        val originalOperations = LinkedList(operations)
    ...
    fun testExternalMultipleFeeNotEnoughFunds() {
        ...
        val operations = LinkedList<WalletOperation>()
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 1, "USD", BigDecimal.valueOf(-10.12)))
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 2, "USD", BigDecimal.valueOf(10.12)))
        val receiptOperation = operations[1]
        val originalOperations = LinkedList(operations)
    ...
    fun testNegativeReceiptOperationAmount() {
        val operations = LinkedList<WalletOperation>()
        operations.add(WalletOperation(DEFAULT_BROKER, 1000, 1, "USD", BigDecimal.valueOf(-900.0)))

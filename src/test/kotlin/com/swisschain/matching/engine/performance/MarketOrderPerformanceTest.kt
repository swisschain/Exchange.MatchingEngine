...
class MarketOrderPerformanceTest: AbstractPerformanceTest() {
    ...
    fun testNoLiqudity(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.5, volume = 1000.0, walletId = "Client1"))
        initServices()
    ...
    fun testNotEnoughFundsClientOrder(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.6, volume = 1000.0, walletId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.5, volume = 1000.0, walletId = "Client2"))
        initServices()

        counter.executeAction {marketOrderService.processMessage(MessageBuilder.buildMarketOrderWrapper(MessageBuilder.buildMarketOrder(walletId = "Client3", assetId = "EURUSD", volume = -1000.0)))}
        return counter.getAverageTime()
    }
    ...
    fun testNotEnoughFundsClientMultiOrder(): Double {
        ...
        counter.executeAction { marketOrderService.processMessage(MessageBuilder.buildMarketOrderWrapper(MessageBuilder.buildMarketOrder(walletId = "Client3", assetId = "EURUSD", volume = -1500.0))) }
    ...
    fun testNoLiqudityToFullyFill(): Double {
        ...
        counter.executeAction { marketOrderService.processMessage(MessageBuilder.buildMarketOrderWrapper(MessageBuilder.buildMarketOrder(walletId = "Client3", assetId = "EURUSD", volume = -2000.0))) }
        return counter.getAverageTime()
    }
    ...
    fun testNotEnoughFundsMarketOrder(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.5, volume = 1000.0, walletId = "Client3"))
        initServices()

        counter.executeAction { marketOrderService.processMessage(MessageBuilder.buildMarketOrderWrapper(MessageBuilder.buildMarketOrder(walletId = "Client4", assetId = "EURUSD", volume = -1000.0))) }
        return counter.getAverageTime()
    }
    ...
    fun testMatchOneToOneEURJPY(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "EURJPY", price = 122.512, volume = 1000000.0, walletId = "Client3"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "EURJPY", price = 122.524, volume = -1000000.0, walletId = "Client3"))
        initServices()
        ...
        counter.executeAction {marketOrderService.processMessage(MessageBuilder.buildMarketOrderWrapper(MessageBuilder.buildMarketOrder(walletId = "Client4", assetId = "EURJPY", volume = 10.0, straight = false)))}
    ...
    fun testMatchOneToMany(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.5, volume = 100.0, walletId = "Client3"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.4, volume = 1000.0, walletId = "Client1"))
        initServices()
    ...
    fun testMatchOneToMany2016Dec12(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008826, volume = -4000.0, walletId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008844, volume = -4000.0, walletId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008861, volume = -4000.0, walletId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008879, volume = -4000.0, walletId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008897, volume = -4000.0, walletId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008914, volume = -4000.0, walletId = "Client1"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(assetId = "SLRBTC", price = 0.00008932, volume = -4000.0, walletId = "Client1"))
        initServices()
        testBalanceHolderWrapper.updateBalance("Client1", "SLR", 100000.0)
        testBalanceHolderWrapper.updateBalance("Client4", "BTC", 31.95294)

        counter.executeAction { marketOrderService.processMessage(MessageBuilder.buildMarketOrderWrapper(MessageBuilder.buildMarketOrder(walletId = "Client4", assetId = "SLRBTC", volume = 25000.0, straight = true))) }
    ...
    fun testNotStraight(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.5, volume = -500.0, assetId = "EURUSD", walletId = "Client3"))
        initServices()
        testBalanceHolderWrapper.updateBalance("Client3", "EUR", 500.0)
        testBalanceHolderWrapper.updateBalance("Client4", "USD", 750.0)

        counter.executeAction { marketOrderService.processMessage(MessageBuilder.buildMarketOrderWrapper(MessageBuilder.buildMarketOrder(walletId = "Client4", assetId = "EURUSD", volume = -750.0, straight = false))) }
        return counter.getAverageTime()
    }
    ...
    fun testNotStraightMatchOneToMany(): Double {
        ...
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.4, volume = -100.0, walletId = "Client3"))
        primaryOrdersDatabaseAccessor.addLimitOrder(MessageBuilder.buildLimitOrder(price = 1.5, volume = -1000.0, walletId = "Client1"))
        initServices()
        ...
        counter.executeAction { marketOrderService.processMessage(MessageBuilder.buildMarketOrderWrapper(MessageBuilder.buildMarketOrder(walletId = "Client4", assetId = "EURUSD", volume = -1490.0, straight = false))) }
        return counter.getAverageTime()
    }
}
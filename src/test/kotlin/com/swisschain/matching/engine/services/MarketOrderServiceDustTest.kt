...
class MarketOrderServiceDustTest: AbstractTest() {
    ...
    fun testDustMatchOneToOne() {
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCUSD", price = 1000.0, volume = 1000.0, walletId = "Client3"))
        testBalanceHolderWrapper.updateBalance("Client3", "USD", 1500.0)
        testBalanceHolderWrapper.updateBalance("Client4", "BTC", 0.020009)
        initServices()

        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "BTCUSD", volume = -0.02)))
...
//        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTC1USD", price = 610.96, volume = 1000.0, walletId = "Client3"))
//        testBalanceHolderWrapper.updateBalance("Client3", "USD", 1500.0)
//        testBalanceHolderWrapper.updateBalance("Client4", "BTC1", 0.14441494999999982)
//        initServices()
//
//        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "BTC1USD", volume = 88.23, straight = false)))
//        assertEquals(1, clientsEventsQueue.size)
//        val event = clientsEventsQueue.poll() as ExecutionEvent
//        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
//        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)
...
//        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTC1USD", price = 598.916, volume = 1000.0, walletId = "Client3"))
//        testBalanceHolderWrapper.updateBalance("Client3", "USD", 1500.0)
//        testBalanceHolderWrapper.updateBalance("Client4", "BTC1", 0.033407)
//        initServices()
//
//        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "BTC1USD", volume = 20.0, straight = false)))
//        assertEquals(1, clientsEventsQueue.size)
//        val event = clientsEventsQueue.poll() as ExecutionEvent
//        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
//        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)
...
//        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTC1USD", price = 593.644, volume = 1000.0, walletId = "Client3"))
//        testBalanceHolderWrapper.updateBalance("Client3", "USD", 1500.0)
//        testBalanceHolderWrapper.updateBalance("Client4", "BTC1", 0.00092519)
//        initServices()
//
//        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "BTC1USD", volume = 0.54, straight = false)))
//        assertEquals(1, clientsEventsQueue.size)
//        val event = clientsEventsQueue.poll() as ExecutionEvent
//        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
//        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)
...
//        testOrderBookWrapper.addLimitOrder(buildLimitOrder(price = 1000.0, volume = 500.0, assetId = "BTCUSD", walletId = "Client3"))
//        testBalanceHolderWrapper.updateBalance("Client3", "USD", 500.0)
//        testBalanceHolderWrapper.updateBalance("Client4", "BTC", 0.02001)
//        initServices()
//
//        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "BTCUSD", volume = 20.0, straight = false)))
//        assertEquals(1, clientsEventsQueue.size)
//        val event = clientsEventsQueue.poll() as ExecutionEvent
//        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
//        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)
...
//    }
    ...
    fun testBuyDustStraight() {
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(price = 1000.0, volume = -500.0, assetId = "BTC1USD", walletId = "Client3"))
        testBalanceHolderWrapper.updateBalance("Client3", "BTC1", 0.02001)
        testBalanceHolderWrapper.updateBalance("Client4", "USD", 500.0)
        initServices()

        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "BTC1USD", volume = 0.0000272, straight = true)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)
...
//        testOrderBookWrapper.addLimitOrder(buildLimitOrder(price = 0.0000782, volume = -4000.0, assetId = "SLRBTC1", walletId = "Client3"))
...
//        initServices()
//
//        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "SLRBTC1", volume = 127.87, straight = true)))
//        assertEquals(1, clientsEventsQueue.size)
//        val event = clientsEventsQueue.poll() as ExecutionEvent
//        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
//        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)
...
//        initServices()
//
//        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "SLRBTC1", volume = -0.01, straight = false)))
//        assertEquals(1, clientsEventsQueue.size)
//        val event = clientsEventsQueue.poll() as ExecutionEvent
//        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
//        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)
...
//        testOrderBookWrapper.addLimitOrder(buildLimitOrder(price = 19739.43939992, volume = 500.0, assetId = "BTC1LKK", walletId = "Client3"))
//        testBalanceHolderWrapper.updateBalance("Client3", "LKK", 500.0)
//        testBalanceHolderWrapper.updateBalance("Client4", "BTC1", 0.02001)
//        initServices()
//
//        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "BTC1LKK", volume = 0.01, straight = false)))
//        assertEquals(1, clientsEventsQueue.size)
//        val event = clientsEventsQueue.poll() as ExecutionEvent
//        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
//        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)
...
//    }
    ...
    @Test
    fun testDust1() {
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(price = 1000.0, volume = -0.05, assetId = "BTC1USD", walletId = "Client3"))
        testBalanceHolderWrapper.updateBalance("Client4", "USD", 5000.0)
        testBalanceHolderWrapper.updateBalance("Client3", "BTC1", 10.0)
        initServices()

        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "BTC1USD", volume = 0.04997355, straight = true)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)
    ...
    fun testDust3() {
        ...
        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client4", assetId = "BTC1USD", volume = 0.0499727, straight = true)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
        val eventMarketOrder = event.orders.single { it.orderType == OrderType.MARKET }
        assertEquals(OutgoingOrderStatus.MATCHED, eventMarketOrder.status)

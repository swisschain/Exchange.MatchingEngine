...
class StopLimitOrderTest : AbstractTest() {
    ...
    fun setUp() {
        ...
        testBalanceHolderWrapper.updateReservedBalance(1, "USD", 0.0)
    ...
    fun testNotEnoughFunds() {
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = 1, assetId = "BTCUSD", volume = -1.01,
    ...
    fun testAddStopLimitOrder() {
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = 1, assetId = "BTCUSD", volume = -0.01,
                type = LimitOrderType.STOP_LIMIT, lowerLimitPrice = 9500.0, lowerPrice = 9000.0
        )))
        ...
        assertEquals(BigDecimal.valueOf(0.01), balancesHolder.getReservedBalance(DEFAULT_BROKER, 1000, 1, "BTC"))
        assertEquals(BigDecimal.valueOf(0.01), testWalletDatabaseAccessor.getReservedBalance(1, "BTC"))
        ...
        assertEventBalanceUpdate(1, "BTC", "1", "1", "0", "0.01", executionEvent.balanceUpdates!!)
    }
    ...
    fun testAddStopLimitOrderAndCancelAllPrevious() {
        ...
        clearMessageQueues()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = 1, assetId = "BTCUSD", type = LimitOrderType.STOP_LIMIT, volume = -0.02,
        ...
        assertEquals(BigDecimal.valueOf(0.02), balancesHolder.getReservedBalance(DEFAULT_BROKER, 1000, 1, "BTC"))
        assertEquals(BigDecimal.valueOf(0.02), testWalletDatabaseAccessor.getReservedBalance(1, "BTC"))
        ...
        assertEquals(1, executionEvent.balanceUpdates!!.size)
        assertEventBalanceUpdate(1, "BTC", "1", "1", "0.01", "0.02", executionEvent.balanceUpdates!!)
    }

    @Test
    fun testCancelStopLimitOrder() {
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                uid = "order1", walletId = 1, assetId = "BTCUSD", volume = -0.01,
                type = LimitOrderType.STOP_LIMIT, lowerLimitPrice = 9500.0, lowerPrice = 9000.0
        )))
        ...
        assertNull(executionEvent.orders.first().rejectReason)
        assertEquals(1, executionEvent.balanceUpdates!!.size)
        assertEventBalanceUpdate(1, "BTC", "1", "1", "0.01", "0", executionEvent.balanceUpdates!!)
    }
    ...
    fun testProcessStopLimitOrder() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                uid = "order2", walletId = 1, assetId = "BTCUSD", volume = -0.03,
                type = LimitOrderType.STOP_LIMIT, lowerLimitPrice = 9500.5, lowerPrice = 9000.0
        )))

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = 0.03, price = 9501.0)))
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = 0.03, price = 9499.0)))

        clearMessageQueues()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 3, assetId = "BTCUSD", volume = -0.03, price = 9501.0)))

        assertBalance(1, "BTC", reserved = 0.01)
        ...
        assertEventBalanceUpdate(1, "BTC", "1", "0.97", "0.04", "0.01", executionEvent.balanceUpdates!!)
        assertEventBalanceUpdate(2, "USD", "1000", "430", "570", "0", executionEvent.balanceUpdates!!)
    }
    ...
    fun testProcessStopOrderAfterRejectLimitOrderWithCancelPrevious() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = -0.1, price = 10000.0)))
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 3, assetId = "BTCUSD", volume = -0.1, price = 11000.0)))

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = 1, assetId = "BTCUSD", volume = 0.05, type = LimitOrderType.STOP_LIMIT,
                upperLimitPrice = 10500.0, upperPrice = 11000.0
        )))

        clearMessageQueues()
        // cancel previous orders and will be rejected due to not enough funds
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = -0.2, price = 10000.0), true))
        ...
        assertEquals(executionEvent.header.messageType, OutgoingMessageType.ORDER)
        assertEquals(5, executionEvent.orders.size)
        val eventClientOrder = executionEvent.orders.single { it.walletId == 1L && it.orderType == OrderType.LIMIT }
    ...
    fun testProcessStopLimitOrderAfterLimitOrderCancellation() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                uid = "order1", walletId = 1, assetId = "BTCUSD", volume = 0.09,
                type = LimitOrderType.STOP_LIMIT, upperLimitPrice = 10000.0, upperPrice = 10500.0
        )))
        assertStopOrderBookSize("BTCUSD", true, 1)
        assertBalance(1, "USD", reserved = 945.0)

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, uid = "order2", assetId = "BTCUSD", volume = -0.1, price = 9000.0)))
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = -0.2, price = 10000.0)))
    ...
    fun testRejectStopOrderDuringMatching() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = 0.03, price = 9600.0)))

        // Order leading to negative spread. Added to reject stop order.
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 1, assetId = "BTCUSD", volume = 0.03, price = 9500.0)))
        ...
        clearMessageQueues()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 3, assetId = "BTCUSD", volume = -0.03, price = 9600.0)))

        assertOrderBookSize("BTCUSD", true, 1)
        assertStopOrderBookSize("BTCUSD", false, 0)
        assertBalance(1, "BTC", reserved = 0.0)

        // new contract event assertion
        assertEquals(1, clientsEventsQueue.size)
        val executionEvent = clientsEventsQueue.single() as ExecutionEvent
        assertEquals(4, executionEvent.orders.size)
        val eventStopOrder = executionEvent.orders.single { it.walletId == 1L && it.orderType == OrderType.STOP_LIMIT }
        assertEquals(OutgoingOrderStatus.EXECUTED, eventStopOrder.status)
    ...
    fun testProcessStopLimitOrderAfterMarketOrder() {
        testBalanceHolderWrapper.updateBalance(2, "BTC", 0.3)
        testBalanceHolderWrapper.updateBalance(3, "USD", 1900.0)
        initServices()
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = -0.1, price = 9000.0)))
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = -0.2, price = 10000.0, uid = "TwoTradesOrder")))

        clearMessageQueues()
        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = 3, assetId = "BTCUSD", volume = 0.2)))
    ...
    private fun processStopLimitOrderAfterMultiLimitOrderCancellation(forTrustedClient: Boolean) {
        if (forTrustedClient) {
            testSettingsDatabaseAccessor.createOrUpdateSetting(AvailableSettingGroup.TRUSTED_CLIENTS, getSetting("2"))
        }
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 3, assetId = "BTCUSD", volume = -0.1, price = 10000.0)))

        clearMessageQueues()
        val message = messageBuilder.buildLimitOrderMassCancelWrapper(2, "BTCUSD", false)
    ...
    fun testProcessStopLimitOrderAfterMinVolumeOrdersCancellation() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = 1, assetId = "BTCUSD", volume = 0.09,
                type = LimitOrderType.STOP_LIMIT, upperLimitPrice = 11000.0, upperPrice = 11000.0
        )))

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = 1, assetId = "EURUSD", volume = -5.0,
        ...
        assertBalance(1, "USD", reserved = 990.0)
        assertBalance(1, "EUR", reserved = 5.0)
        ...
        assertBalance(1, "USD", 15.0, 0.0)
        assertBalance(1, "EUR", 0.0, 0.0)
    ...
    fun testProcessStopLimitOrdersChain() {
        testBalanceHolderWrapper.updateBalance(3, "USD", 10000.0)
        testBalanceHolderWrapper.updateBalance(2, "USD", 10000.0)
        testBalanceHolderWrapper.updateBalance(2, "BTC", 1.0)
        initServices()

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = 0.1, price = 10000.0)))
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = 0.1, price = 9500.0)))
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = 0.1, price = 9000.0)))

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = 1, assetId = "BTCUSD", volume = -0.2,
                type = LimitOrderType.STOP_LIMIT, upperLimitPrice = 10500.0, upperPrice = 10000.0
        )))

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = 1, assetId = "BTCUSD", volume = -0.1,
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = 3, assetId = "BTCUSD", volume = 0.1,
                type = LimitOrderType.STOP_LIMIT, lowerLimitPrice = 9000.0, lowerPrice = 9000.0
        )))
        ...
        assertEquals(BigDecimal.valueOf(0.5), balancesHolder.getReservedBalance(DEFAULT_BROKER, 1000, 1, "BTC"))
        assertEquals(BigDecimal.valueOf( 900.0), balancesHolder.getReservedBalance(DEFAULT_BROKER, 1000, 3, "USD"))

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = 0.1, price = 10500.0)))
        ...
        assertTrue(genericStopLimitOrderService.getOrderBook(DEFAULT_BROKER, "BTCUSD").getOrderBook(false).isEmpty())
        assertEquals(BigDecimal.ZERO, balancesHolder.getReservedBalance(DEFAULT_BROKER, 1000, 1, "BTC"))
        assertEquals(BigDecimal.ZERO, balancesHolder.getReservedBalance(DEFAULT_BROKER, 1000, 3, "USD"))
    }
    ...
    fun testProcessBothSideStopLimitOrders() {
        ...
        testBalanceHolderWrapper.updateBalance(3, "USD", 1050.0)
        testBalanceHolderWrapper.updateBalance(2, "BTC", 0.1)
        testBalanceHolderWrapper.updateBalance(2, "USD", 900.0)
        initServices()
        ...
        assertEquals(1, genericStopLimitOrderService.getOrderBook(DEFAULT_BROKER, "BTCUSD").getOrderBook(true).size)
        assertEquals(1, genericStopLimitOrderService.getOrderBook(DEFAULT_BROKER, "BTCUSD").getOrderBook(false).size)
        assertEquals(BigDecimal.valueOf( 0.1), balancesHolder.getReservedBalance(DEFAULT_BROKER, 1000, 1, "BTC"))
        assertEquals(BigDecimal.valueOf(1050.0), balancesHolder.getReservedBalance(DEFAULT_BROKER, 1000, 3, "USD"))
    ...
    fun testProcessStopLimitOrderImmediately() {
        testBalanceHolderWrapper.updateBalance(2, "BTC", 0.1)
        initServices()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD", volume = -0.1, price = 9900.0)))
        clearMessageQueues()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(uid = "order1", walletId = 1, assetId = "BTCUSD", volume = 0.1,
    ...
    fun testFullMatchSeveralStopOrdersWithIncomingOrder() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 1, assetId = "BTCUSD",
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 2, assetId = "BTCUSD",
    ...
    fun testExpiredStopLimitOrder() {
        val order = buildLimitOrder(walletId = 1, assetId = "BTCUSD",
                type = LimitOrderType.STOP_LIMIT,
                volume = -1.0,
                lowerLimitPrice = 1.0,
                lowerPrice = 1.0,
    ...
    fun testProcessImmediateOrCancelStopLimitOrderWithTrades() {
        testBalanceHolderWrapper.updateBalance(2, "USD", 0.5)
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = 1, assetId = "BTCUSD",
                type = LimitOrderType.STOP_LIMIT,
                volume = -1.0,
                lowerLimitPrice = 1.0,

...
class LimitOrderServiceTest : AbstractTest() {
    ...
    fun testTrustedClientNotEnoughFundsBuyClientInOrderBook() {
        ...
        initServices()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client3", price = 1.1, volume = -1000.0)))
        assertEquals(1, testOrderDatabaseAccessor.getOrders("EURUSD", false).size)

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", price = 1.2, volume = 2000.0)))
    ...
    fun testTrustedClientNotEnoughFundsPartialMatched() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", price = 1.2, volume = 100.0)))
        val event = clientsEventsQueue.poll() as ExecutionEvent
    ...
    fun testRestartAndCancel() {
        ...
        assertNotNull(genericLimitOrderService.searchOrders(DEFAULT_BROKER, "Client1", "EURUSD", true).find { it.externalId == "2" })
    ...
    fun testAddAndMatchLimitOrder() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "EURUSD", price = 122.512, volume = -10.0, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "EURUSD", price = 122.524, volume = -10.0, walletId = "Client3"))
    ...
    fun testAddAndMatchLimitOrderRounding() {
        ...
        initServices()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", price = 4199.351, volume = 0.00357198)))
        assertEquals(1, clientsEventsQueue.size)
        var event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.PLACED, event.orders.single().status)
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client3", assetId = "BTCUSD", price = 4199.351, volume = -0.00357198)))
    ...
    fun testStatusDate() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", uid = "order1", assetId = "EURUSD", volume = -1.0, price = 1.0)))
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "EURUSD", volume = 0.4, price = 1.0)))
    ...
    fun testAddLimitOrderEURUSD() {
        ...
        initServices()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", price = 325.7152, volume = 0.046053)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
    ...
    fun testAddAndMatchLimitOrderWithDust() {
        ...
        initServices()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(assetId = "BTCEUR", walletId = "Client1", price = 3200.0, volume = -0.01)))
        assertEquals(1, clientsEventsQueue.size)
        var event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(1, event.orders.size)
        assertEquals(OutgoingOrderStatus.PLACED, event.orders[0].status)

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(assetId = "BTCEUR", walletId = "Client3", price = 3200.0, volume = 0.009973)))
        assertEquals(1, clientsEventsQueue.size)
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(2, event.orders.size)
        assertEquals(OutgoingOrderStatus.MATCHED, event.orders[0].status)
    ...
    fun testAddAndMatchLimitOrderWithDust1() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(assetId = "BTCEUR", walletId = "Client3", price = 3200.0, volume = 0.01002635)))
        assertEquals(1, clientsEventsQueue.size)
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(2, event.orders.size)
    ...
    fun testAddAndMatchLimitSellDustOrder() {
        testBalanceHolderWrapper.updateBalance("Client3", "EUR", 1000.0)
        testBalanceHolderWrapper.updateBalance("Client1", "BTC", 1000.0)
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3583.081, volume = 0.00746488, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3581.391, volume = 0.00253512, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3579.183, volume = 0.00253512, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3578.183, volume = 0.00253512, walletId = "Client3"))
    ...
    fun testAddAndMatchBuyLimitDustOrder() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3827.395, volume = -0.00703833, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3830.926, volume = -0.01356452, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3832.433, volume = -0.02174805, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3836.76, volume = -0.02740016, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3838.624, volume = -0.03649953, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3842.751, volume = -0.03705699, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3845.948, volume = -0.04872587, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3847.942, volume = -0.05056858, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3851.385, volume = -0.05842735, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3855.364, volume = -0.07678406, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3858.021, volume = -0.07206853, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3861.283, volume = -0.05011803, walletId = "Client3"))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "BTCEUR", price = 3863.035, volume = -0.1, walletId = "Client3"))

        initServices()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "BTCEUR", price = 3890.0, volume = 0.5)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
    ...
    fun testAddMatchWithMarketOrder() {
        ...
        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client3", assetId = "EURUSD", volume = -10.0)))
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.PARTIALLY_MATCHED, event.orders[0].status)
        assertEquals("1", event.orders[0].remainingVolume)
    ...
    fun testAddAndMatchWithLimitOrder() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client4", assetId = "BTCUSD", price = 4425.0, volume = 0.032)))
        assertEquals(1, clientsEventsQueue.size)
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.PARTIALLY_MATCHED, event.orders[0].status)
    ...
    fun testAddAndMatchAndCancel() {
        ...
        initServices()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "ETHBTC", uid = "1", price = 0.07963, volume = 2.244418)))
        assertEquals(1, clientsEventsQueue.size)
        var event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.PLACED, event.orders[0].status)
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "ETHBTC", uid = "2", price = 0.07948, volume = -0.01462)))
        assertEquals(1, clientsEventsQueue.size)
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.MATCHED, event.orders[0].status)
        assertEquals(OutgoingOrderStatus.PARTIALLY_MATCHED, event.orders[1].status)
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "ETHBTC", uid = "3", price = 0.07954, volume = -0.031344)))
        assertEquals(1, clientsEventsQueue.size)
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.MATCHED, event.orders[0].status)
        assertEquals(OutgoingOrderStatus.PARTIALLY_MATCHED, event.orders[1].status)
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "ETHBTC", uid = "4", price = 0.07958, volume = -0.041938)))
        assertEquals(1, clientsEventsQueue.size)
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.MATCHED, event.orders[0].status)
        assertEquals(OutgoingOrderStatus.PARTIALLY_MATCHED, event.orders[1].status)
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "ETHBTC", uid = "5", price = 0.07948, volume = -0.000001)))
        assertEquals(1, clientsEventsQueue.size)
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.MATCHED, event.orders[0].status)
        assertEquals(OutgoingOrderStatus.PARTIALLY_MATCHED, event.orders[1].status)
    ...
    fun testAddAndMatchWithLimitOrder1() {
        ...
        initServices()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client4", assetId = "BTCUSD", price = 4680.0, volume = 0.005)))
        assertEquals(1, clientsEventsQueue.size)
        var event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.PLACED, event.orders[0].status)
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", price = 4650.0, volume = 0.01)))
        assertEquals(1, clientsEventsQueue.size)
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.PLACED, event.orders[0].status)
        assertEquals("0.01", event.orders[0].remainingVolume)

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "BTCUSD", price = 4600.0, volume = -0.005)))
        assertEquals(1, clientsEventsQueue.size)
        event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.MATCHED, event.orders[0].status)
        assertEquals(OutgoingOrderStatus.MATCHED, event.orders[1].status)
    ...
    fun testAddAndMatchWithLimitOrder2() {
        ...
        initServices()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "BTCEUR", price = 3571.922, volume = -0.00662454)))
        clearMessageQueues()

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client4", assetId = "BTCEUR", price = 3571.922, volume = 0.03079574)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(OutgoingOrderStatus.PARTIALLY_MATCHED, event.orders[0].status)
    ...
    fun testMatchWithOwnLimitOrder() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(price = 1.0, volume = 10.0, walletId = "Client2")))
    ...
    fun testMatchMarketOrderWithOwnLimitOrder() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", price = 1.1, volume = -10.0)))
    ...
    fun testMatchWithLimitOrderForAllFunds() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", price = 4722.0, volume = 0.14825226))
        initServices()

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(assetId = "BTCUSD", walletId = "Client2", price = 4721.403, volume = -0.4435)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(2, event.orders.size)
        assertEquals(OutgoingOrderStatus.MATCHED, event.orders[1].status)
        ...
        assertEquals(BigDecimal.ZERO, testWalletDatabaseAccessor.getReservedBalance("Client1", "USD"))
        assertEquals(BigDecimal.ZERO, balancesHolder.getReservedBalance(DEFAULT_BROKER, "Client1", "USD"))
    ...
    fun testMatchWithSeveralOrdersOfSameClient() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client3", assetId = "BTCUSD", volume = -0.1, price = 6110.0))

        initServices()

        assertEquals(BigDecimal.valueOf(29.99), balancesHolder.getReservedBalance(DEFAULT_BROKER, "Client1", "BTC"))

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "BTCUSD", volume = 30.0, price = 6110.0)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
        ...
        assertEquals(BigDecimal.valueOf(70.01), balancesHolder.getBalance(DEFAULT_BROKER, "Client1", "BTC"))
    ...
    fun testMatchWithNotEnoughFundsOrder1() {
        ...
        val order = buildLimitOrder(walletId = "Client1", assetId = "EURUSD", price = 1.2, volume = 1.0)
        order.reservedLimitVolume = BigDecimal.valueOf(1.19)
        testOrderBookWrapper.addLimitOrder(order)

        initServices()

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(assetId = "EURUSD", price = 1.1, volume = -2.0, walletId = "Client2")))
    ...
    fun testMatchWithNotEnoughFundsOrder2() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(assetId = "EURUSD", price = 1.2, volume = 1.0, walletId = "Client1", reservedVolume = 1.19))
    ...
    fun testMatchWithNotEnoughFundsOrder4() {
        ...
        val order1 = buildLimitOrder(walletId = "Client1", assetId = "EURUSD", price = 1.2, volume = 1.0)
        order1.reservedLimitVolume = BigDecimal.valueOf(1.19)
        testOrderBookWrapper.addLimitOrder(order1)

        val order2 = buildLimitOrder(walletId = "Client4", assetId = "EURUSD", price = 1.15, volume = 1.0)
    ...
    fun testMatchSellMinRemaining() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(assetId = "BTCUSD", price = 5000.0, volume = 0.01, walletId = "Client1")))
        ...
        clearMessageQueues()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "BTCUSD", price = 4998.0, volume = -0.01000199)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(2, event.orders.size)
    ...
    fun testMatchSellWithOppositeMinRemaining() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(assetId = "BTCUSD", price = 5000.0, volume = 0.01000199, walletId = "Client1")))

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "BTCUSD", price = 5000.0, volume = -0.01)))
        clearMessageQueues()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "BTCUSD", price = 5000.0, volume = -0.01)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
    ...
    fun testMatchBuyMinRemaining() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(assetId = "BTCUSD", price = 5000.0, volume = -0.01, walletId = "Client1")))
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(assetId = "BTCUSD", price = 5001.0, volume = -0.01, walletId = "Client3")))

        clearMessageQueues()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "BTCUSD", price = 5002.0, volume = 0.01000199)))
        assertEquals(1, clientsEventsQueue.size)
        val event = clientsEventsQueue.poll() as ExecutionEvent
        assertEquals(3, event.orders.size)
    ...
    fun testMatchBuyWithOppositeMinRemaining() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", price = 5000.0, volume = -0.01000199)))
    ...
    fun testMatchNotStraightSellMinRemaining() {
        ...
        clearMessageQueues()
        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(walletId = "Client2", assetId = "BTCUSD", volume = 50.01, straight = false)))
    ...
    fun testOverflowedRemainingVolume() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "PKTETH", price = 0.0001, volume = -2.689999999998)))
        clearMessageQueues()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "PKTETH", price = 0.0001, volume = 100.0)))
        val event = clientsEventsQueue.poll() as ExecutionEvent
    ...
    fun testReservedBalanceAfterMatching() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", volume = -0.00952774, price = 10495.66))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", volume = -0.1, price = 10590.00))
        ...
        marketOrderService.processMessage(buildMarketOrderWrapper(buildMarketOrder(
                walletId = "Client2", assetId = "BTCUSD", volume = -100.0, straight = false
        )))
    ...
    fun testLimitOrderSellFullBalance() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client2", assetId = "LKK1YLKK", volume = 4.97, price = 1.0105))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client2", assetId = "LKK1YLKK", volume = 5500.0, price = 1.0085))
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(
                buildLimitOrder(
                        ...
                        volume = -5495.03,
                        price = 1.0082,
                        fees = MessageBuilder.buildLimitOrderFeeInstructions(type = FeeType.CLIENT_FEE, takerSize = 0.0009, targetWalletId = "Client5", makerFeeModificator = 0.0)
                )
        ))
    ...
    fun testImmutableReportOrder1() {
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                uid = "order1", walletId = "Client1", assetId = "EURUSD", volume = -1.0, price = 1.0
        )))
    ...
    fun testImmutableReportOrder2() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = "Client2", assetId = "EURUSD", volume = 0.1, price = 1.0
        )))
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(
                walletId = "Client2", assetId = "EURUSD", volume = 0.2, price = 1.0
        )))
        assertEquals(2, clientsEventsQueue.size)
        val event1 = clientsEventsQueue.poll() as ExecutionEvent
    ...
    fun testOrderMaxValue() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", volume = -1.1, price = 10000.0)))
    ...
    fun testBuyPriceDeviationThreshold() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", price = 10000.0, volume = -0.3))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", price = 11000.0, volume = -0.3))

        applicationSettingsCache.createOrUpdateSettingValue(AvailableSettingGroup.LO_PRICE_DEVIATION_THRESHOLD, "BTCUSD", "0.09", true)

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "BTCUSD", price = 11000.0, volume = 1.0)))
    ...
    fun testSellPriceDeviationThreshold() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client2", assetId = "BTCUSD", price = 13000.0, volume = 0.3))
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client2", assetId = "BTCUSD", price = 12000.0, volume = 0.3))

        applicationSettingsCache.createOrUpdateSettingValue(AvailableSettingGroup.LO_PRICE_DEVIATION_THRESHOLD, "BTCUSD", "0.07", true)

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "BTCUSD", price = 12000.0, volume = -1.0)))
    ...
    fun testCancelLimitOrdersAfterRejectedIncomingOrder() {
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client1", assetId = "EURUSD", volume = -50.0, price = 1.1,
        ...
        testOrderBookWrapper.addLimitOrder(buildLimitOrder(walletId = "Client1", assetId = "EURUSD", volume = -50.0, price = 1.2))

        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "EURUSD", volume = 50.0, price = 1.2,
    ...
    fun testMatchWithExpiredOrder() {
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1", assetId = "EURUSD", volume = 20.0, price = 1.1)))
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(uid = "1", walletId = "Client1", assetId = "EURUSD", volume = 20.0, price = 1.2,
        ...
        clearMessageQueues()
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client2", assetId = "EURUSD", volume = -15.0, price = 1.1)))
    ...
    fun testExpiredOrder() {
        val order = buildLimitOrder(walletId = "Client1", assetId = "EURUSD", volume = 1.0, price = 1.0,
                timeInForce = OrderTimeInForce.GTD,
                expiryTime = Date())
        Thread.sleep(10)
    ...
    fun testImmediateOrCancelOrderWithTrades() {
        ...
        singleLimitOrderService.processMessage(messageBuilder.buildLimitOrderWrapper(buildLimitOrder(walletId = "Client1",
                assetId = "EURUSD",
                volume = 30.0,
                price = 1.3,

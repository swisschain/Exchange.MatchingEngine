...
class MatchingEngineMarketOrderTest : MatchingEngineTest() {
    ...
    fun testMatchMarketOrderBuyOneToOne() {
        ...
        assertCashMovementsEquals(
                listOf(
                        ...
                        WalletOperation(DEFAULT_BROKER, 1000,  1, "USD", BigDecimal.valueOf(-108.41), BigDecimal.ZERO)
                ),
        ...
        assertCashMovementsEquals(
                listOf(
                        WalletOperation(DEFAULT_BROKER, 1000,  2, "EUR", BigDecimal.valueOf(-91.1), BigDecimal.valueOf(-91.1)),
                        WalletOperation(DEFAULT_BROKER, 1000,  2, "USD", BigDecimal.valueOf(108.41), BigDecimal.ZERO)
                ),
    ...
    fun testMatchMarketOrderNotStraightBuyOneToOneFully() {
        ...
        assertMarketOrderMatchingResult(matchingResult, status = OrderStatus.Matched, marketBalance = BigDecimal.valueOf(880.0),
                marketPrice = BigDecimal.valueOf(1.2), cashMovementsSize = 4, marketOrderTradesSize = 1, completedLimitOrdersSize = 1,
                limitOrdersReportSize = 1)

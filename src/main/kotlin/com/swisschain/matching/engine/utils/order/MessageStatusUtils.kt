...
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.BALANCE_LOWER_THAN_RESERVED
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.DISABLED_ASSET
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.GENERIC_VALIDATION_FAILURE
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.INVALID_FEE
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.INVALID_PRICE_ACCURACY
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.INVALID_VOLUME_ACCURACY
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.LIMIT_ORDER_NOT_FOUND
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.LOW_BALANCE
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.NEGATIVE_OVERDRAFT_LIMIT
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.NO_LIQUIDITY
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.RESERVED_VOLUME_HIGHER_THAN_BALANCE
import com.swisschain.matching.engine.services.validators.impl.ValidationException.Validation.TOO_SMALL_VOLUME

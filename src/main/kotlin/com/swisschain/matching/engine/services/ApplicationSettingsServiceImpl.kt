...
import com.swisschain.matching.engine.daos.setting.SettingNotFoundException
...
import com.swisschain.matching.engine.services.events.ApplicationGroupDeletedEvent
import com.swisschain.matching.engine.services.events.ApplicationSettingCreatedOrUpdatedEvent
import com.swisschain.matching.engine.services.events.ApplicationSettingDeletedEvent
...
class ApplicationSettingsServiceImpl(private val settingsDatabaseAccessor: SettingsDatabaseAccessor,
    ...
    private fun toSettingHistoryRecord(settingsGroupName: String,
        ...
        return setting.let {
            SettingHistoryRecord(settingsGroupName, it.name, it.value, it.enabled, comment, user, Date())
        }
    }

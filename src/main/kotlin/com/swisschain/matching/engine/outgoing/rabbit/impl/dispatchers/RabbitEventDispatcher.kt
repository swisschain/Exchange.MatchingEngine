package com.swisschain.matching.engine.outgoing.rabbit.impl.dispatchers
...
class RabbitEventDispatcher<E>(private val dispatcherName: String,
    ...
    companion object {
        ...
        val LOGGER = LoggerFactory.getLogger(RabbitEventDispatcher::class.java)
    }
    ...
    @EventListener
    fun onRabbitFailure(rabbitFailureEvent: RabbitFailureEvent<E>) {
    ...
    @EventListener
    fun onRabbitReady(rabbitReadyEvent: RabbitReadyEvent) {
